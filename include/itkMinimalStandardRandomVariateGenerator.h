...
#include "ContrastLimitedAdaptiveHistogramEqualizationExport.h"
 ...
 */
class ContrastLimitedAdaptiveHistogramEqualization_EXPORT MinimalStandardRandomVariateGenerator : public RandomVariateGeneratorBase
{
public:
